...
-- Politica para insercao (requer admin autenticado)
-- Nota: O service_role key automaticamente bypassa RLS
...
-- Politica para atualizacao (requer admin autenticado)
...
-- Politica para delecao (requer admin autenticado)
